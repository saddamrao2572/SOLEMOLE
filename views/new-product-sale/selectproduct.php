        ...
        <div class="tz-2-com tz-2-main">
          ...
          <div class="db-list-com tz-db-table" style="height: auto;">
            ...
            <div class="tz2-form-pay tz2-form-com">
                ...
                <?php $form = ActiveForm::begin(['method'=> 'post' , 'action' => '/new-product-sale/postvalues',  'options' => ['enctype' => 'multipart/form-data','id' => 'dynamic-form' , 'class' => 'col s12' , ]]);?>
                ...
                <div class="row">
                  <div class="input-field col s12">
                    <input type="submit" name="btn_newsell"  class="btn btn-default pull-right col s12 m3" value="Next"> 
    ...
    $(document).ready(function(){
        $("#searchbox").change(function(event){
           ...
           //console.log(data1);
            ...
            $.get("/new-product-sale/valueshow",{'pn':pname , 'shopid':shop},function(data){
                $("#dataget").empty();
                $("#dataget").append(data);
                $(".img").show();
