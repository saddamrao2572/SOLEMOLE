...
<div class="row">
	...
	<section class="tz-register" style="margin-top: -20px">
			...
			<?= $form->field($model, 'email')->textInput(['disabled' => true]) ?>
						...
						<div>
							<div class="validate ng-pristine ng-valid ng-empty ng-touched">
			<?= $form->field($model, 'password_hash')->textInput(['value' => ''])->label('New Password')->passwordInput() ?>
							</div>
						</div>
						<div>
							<div class="validate ng-pristine ng-valid ng-empty ng-touched">
			<?= $form->field($model, 'password_repeat')->label('Repeat New Password')->passwordInput() ?>
							</div>
						</div>
