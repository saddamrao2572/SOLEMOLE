...
/* @var $searchModel app\models\TopTrendingSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Top Trendings');
...
<div class="top-trending-index">

    
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Top Trending'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
