    ...
    height: 100px;" alt="related<?=$count?>" src="/uploads/shop-post/<?=$img->img?>" class="img-fluid"></a>
						...
						<?php }} ?>
                            ...
                            <div class="gradient-padding">
								...
								<?php 
		          $posts = app\models\ShopPost::find()->where(['shop_id'=>$model->shop_id])->all();
				  if(isset($posts))
				  {
					  $count1=0;
								...
								?>
                                    ...
                                    <div class="product-box">
                                        <div class="item-mask-wrapper">
											...
											<img style="    height: 200px;" src="/uploads/shop-post/<?=$post->thumnail?>" alt="categories" class="img-fluid">
                                                <div class="trending-sign active" data-tips="Featured"> <i class="fa fa-bolt" aria-hidden="true"></i> </div>
                                                <div class="title-ctg"><?php if(isset($shop)){echo $shop->name;}?></div>
                                                <ul class="info-link">
                                                    <li><a href="/uploads/shop-post/<?=$post->thumnail?>" class="elv-zoom" data-fancybox-group="gallery" title="Title Here"><i class="fa fa-arrows-alt" aria-hidden="true"></i></a></li>
                                        ...
                                        <div class="item-content">
                                            ...
                                            <h3 class="short-title"><a href="https://www.radiustheme.com/demo/html/classipost/classipost/single-product1#"><?=$post->title?></a></h3>
