...
<?php
  ...
  $updatesale=\app\models\SalesPurchase::find()->where(['id'=>$model->id])->one();
  if (!empty($updatesale)) {
        ...
        <div class="tz-2-com tz-2-main">
          ...
          <div class="db-list-com tz-db-table" style="height: auto;">
            ...
            <div class="tz2-form-pay tz2-form-com">
                ...
                <?php $form = ActiveForm::begin(['method'=> 'post' , 'action' => '/sales-purchase/update?id='.$model->id,  'options' => ['enctype' => 'multipart/form-data','id' => 'dynamic-form' , 'class' => 'col s12' , ]]);?>
          ...
          <input type="hidden" name="brandid" value="<?= $updatesale->brand_id ?>">
                  ...
                  <div class="row">
                    ...
                    <div class="input-field col s12 m10">
                      ...
                      <textarea id="fualt" name="fualt" rows="3" class="validate"  style="height: 100px" >
                        <?php if (!empty($updatesale->fault)) {
                            echo $updatesale->fault;
                        }  ?>
                      </textarea>
                ...
                <style type="text/css">
                  ...
                  <div class="row">
                    ...
                    <div class="input-field col s12 m3">
                      ...
                      <input type="text" class="validate" placeholder=" Contact" name="contact" id="contact" value="<?= $updatesale->contact ;?>">
